 ...
 *    (e.g. font5x7['a'-16][n]).
 *    
 *    Each element is a row of the char. 
 *    font5x7[n][0] is row 1, etc. Blank 
 *    pixel at the top of char for full byte.
 **/

const uint8_t font_5x7_row[128][5] PROGMEM = {
   ...
   { 0x7F, 0x00, 0x00, 0x00, 0x00 }, // (1 row left)
   { 0x7F, 0x7F, 0x00, 0x00, 0x00 }, // (2 row left)
   { 0x7F, 0x7F, 0x7F, 0x00, 0x00 }, // (3 row left)
   { 0x7F, 0x7F, 0x7F, 0x7F, 0x00 }, // (4 row left)
   { 0x7F, 0x7F, 0x7F, 0x7F, 0x7F }, // (solid fill)
   { 0x00, 0x7F, 0x7F, 0x7F, 0x7F }, // (4 row right)
   { 0x00, 0x00, 0x7F, 0x7F, 0x7F }, // (3 row right)
   { 0x00, 0x00, 0x00, 0x7F, 0x7F }, // (2 row right)
   { 0x00, 0x00, 0x00, 0x00, 0x7F }, // (1 row right)
...
/* Not used
const uint8_t font_5x7_row_extended[112][6] PROGMEM = {
